...
struct AddMovie_Previews: PreviewProvider {
    static var previews: some View {
            AddMovie(movies: .constant([Movie(title: "", director: "", image: "", pitch: "", year: 1, genre: .drama, isFavorite: false), Movie(title: "", director: "", image: "", pitch: "", year: 1, genre: .drama, isFavorite: false)]))
        }
}
